...
export const SLIDES = [
  ...
  },
  {
    ...
    titleLines: [
      { words: ['Là', 'où', 'naît'], gradient: false },
      { words: ['le', 'meilleur'], gradient: false },
      { words: ['cacao', 'ivoirien'], gradient: false },
    ],
  ...
  },
  {
    ...
    titleLines: [
      ...
      { words: ['une', 'communauté'], gradient: false },
    ],
  ...
  },
  {
    ...
    titleLines: [
      { words: ['Des', 'milliers'], gradient: false },
      { words: ['de', 'mains'], gradient: false },
      { words: ['une', 'même', 'vision'], gradient: false },
    ],
